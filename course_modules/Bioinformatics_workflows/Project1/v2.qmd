...
In human genomes, the biological ratio of transitions (A↔G, C↔T) to transversions (other changes) is expected to be \~2.0–2.1 for whole-genome sequencing (WGS) and \~3.0–3.2 for exome sequencing due to CpG methylation in coding regions.
