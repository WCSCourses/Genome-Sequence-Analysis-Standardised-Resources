...
**On the VM which runs on Google Cloud Platform, you can run breakdancer by activating its conda environment:**

**`conda activate breakdancer_env`**

**`breakdancer-max`**

**Don't forget to deactivate this conda environment when you are done with breakdancer, using `conda deactivate`**
...
[On the VM which runs on Google Cloud Platform, you can run breakdancer by activating its conda environment:]{style="color: red;"}

**`conda activate breakdancer_env`**

**`breakdancer-max`**

[Don’t forget to deactivate this conda environment when you are done with breakdancer, using `conda deactivate`]{style="color: red;"}
