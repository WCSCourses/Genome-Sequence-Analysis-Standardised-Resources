...
`cd ~/course_data/read_alignment` Now you can follow the instructions in the tutorial from here.
...
Finally, index the merged BAM file. (As the two input BAM files were already sorted before merging, re-sorting the merged file shouldn't be necessary.)
