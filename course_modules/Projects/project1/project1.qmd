---
title: "Project 1: Comparison of variant callers"
format: html
---
...
You will use two iPS cell lineages kolf and kolf_2 from the [HipSci project](http://www.hipsci.org). Download a tarball from the [course Google Drive folder (using the browser in your VM)](https://drive.google.com/file/d/10Y72tqP42LouHu5PVKcP2arn4J7Yar1-/view?usp=drive_link), with the scripts and unpack and prepare the data as follows:
...
**Task 4:** Use the command bcftools isec to find variants with QUAL\>20 called by all three tools (presumably the highest-confidence calls). Explore the output. What is the ts/tv of variants in the intersection?
